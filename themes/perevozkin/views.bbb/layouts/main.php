...
<?
	...
	//$cs1->registerCoreScript('fancybox');
				...
				<div class="width-wrap">
					<?php $this->widget('zii.widgets.CMenu',array(
						'items'=>array(
							...
							array('label'=>'Вход', 'url'=>array('/user/login'), 'visible'=>$this->app->user->isGuest, 'itemOptions'=>array('class'=>'login login-items'), 'linkOptions'=>array('id'=>'login-btn')),
