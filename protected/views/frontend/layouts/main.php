		...
		<div class="width-wrap">
			<div class="clearfix">
				<div class="contacts floatLeft">
					<div class="footer-hdr uppercase">Контакты</div>
					<div class="email">E-mail: info@s-turbo.by</div>
					<div class="phones">Отдел продаж: <br>+375 29 530 22 99 <br>+375 44 530 22 99</div>
					<div class="adress">Мы находимся: <br>г. Минск, АвтоМолл "Кольцо", <br>2-ой этаж, 417 павильон</div>
					<div class="copyright"><p>© <?php echo date('Y'); ?> <span class="site-name">S-TURBO.BY</span> Республика Беларусь</p></div>
				</div>
				
				<div class="ur-data floatLeft">
					<div class="footer-hdr uppercase">Юридические данные</div>
					<div class="txt">220089 г. Минск ул. Гурского 37, офис 5Н, <br>комната 18/23</div>
					<div class="txt">
				...
				<div class="our-shop floatRight">
					<div class="footer-hdr uppercase">Наш магазин</div>
					<a href="#" class="view-map">
						<img src="/images/map.jpg" alt="Наш магазин" />
					</a>
