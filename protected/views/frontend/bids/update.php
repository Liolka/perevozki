...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<?php $model = $cargoModel	?>
	
	<?php echo $form->hiddenField($model,'category_id'); ?>
	
	<?php for ($key=1; $key<=$count_cargoes;$key++)	{	?>
	<? $cat_fld = 'category'.$key?>
	<div id="cargo<?=$key?>" class="step-container pt-25">
		<div class="container ">
			
			<?php $fld = 'cargo_id'.$key?>
				...
				<div class="col-md-7 col-lg-7">
					<div class="row form-row">
						...
						<div class="col-md-5 col-lg-5 upload-foto-block pos-rel">
							...
							<div id="errormes-<?=$key?>" class="font-12 mt-5 pos-abs upload-foto-block-errormes c_eb4c4c"></div>
					...
					<? if($model->$cat_fld != 13 && $model->$cat_fld != 4)	{	?>
