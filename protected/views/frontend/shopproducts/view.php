		...
		<div class="w600 floatleft">
			<?if (!empty($model->shopProductsMediases[0])) {?>
				<div class="main-image">
					<?	echo CHtml::link(CHtml::image($images_live_url.$model->shopProductsMediases[0]->media->file_url, "", array('class' => "medium-image")), $images_live_url.$model->shopProductsMediases[0]->media->file_url, array('class' => "fancybox", "rel" => "group"))	?>
				</div>
			...
			<div class="wrapper-slider">		
				<div class="slider-images clearfix">
					...
					<?foreach($model->shopProductsMediases as $media_item)	{?>
						<li>
							<?	echo CHtml::link(CHtml::image($images_live_url.$media_item->media->file_url_thumb), $images_live_url.$media_item->media->file_url, array('class' => "fancybox", "rel" => "group"))	?>
						</li>
					<?	}	?>
				</div>
			</div>
